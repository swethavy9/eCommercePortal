...
- Create Angular project with ng: `ng new ecommerceportal.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ecommerceportal.client.esproj`).
